import { createPath, createSvgButton } from './Base.js';

export class Timer extends HTMLElement {
  static activeTimers_: Timer[];
  timeDisplay_: HTMLElement;
  timerButton_: SVGElement;
...
Timer duration can be configured in the settings dialogs.`;
  ...
  async render_() {
    ...
    this.timerKey_ = window.setTimeout(this.render_.bind(this), this.countDown_ ? 1000 : 60000);
  }
}
