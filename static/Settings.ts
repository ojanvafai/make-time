...
export class Settings extends EventTargetPolyfill {
  ...
  static fields = [
    ...
    {
      key: ServerStorage.KEYS.PIN_CADENCE,
      name: 'Pin retriage cadence',
      description: `Number of days in which mktime will attempt to show threads for retriage. 0 to disable retriage.`,
      default: 0,
      type: 'number',
    },
    {
      key: ServerStorage.KEYS.BOOKMARK_CADENCE,
      name: 'Bookmark retriage cadence',
      description: `Number of days in which mktime will attempt to show threads for retriage. 0 to disable retriage.`,
      default: 0,
      type: 'number',
    },
    {
      key: ServerStorage.KEYS.MUST_DO_CADENCE,
      name: 'Empty daily retriage cadence',
      description: `Number of days in which mktime will attempt to show threads for retriage. 0 to disable retriage.`,
      default: 2,
      type: 'number',
    },
    {
      key: ServerStorage.KEYS.URGENT_CADENCE,
      name: 'Urgent retriage cadence',
      description: `Number of days in which mktime will attempt to show threads for retriage. 0 to disable retriage.`,
      default: 7,
      type: 'number',
    },
    {
      key: ServerStorage.KEYS.BACKLOG_CADENCE,
      name: 'Backlog retriage cadence',
      description: `Number of days in which mktime will attempt to show threads for retriage. 0 to disable retriage.`,
      default: 28,
      type: 'number',
    },
